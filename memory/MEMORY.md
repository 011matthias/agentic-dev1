...
- [Cross-repo cwd: never cd into dev1 from an ops-rooted session](gotcha_cross_repo_cwd.md); drive by git -C / gh -R / uv run --directory / absolute paths. cd-guard catches `&&` but not `;`.
