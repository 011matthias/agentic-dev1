...
const display = readFileSync(fromRoot('src/assets/og/Fraunces-700.woff'))
const body = readFileSync(fromRoot('src/assets/og/Mulish-400.woff'))
  ...
  const svg = await satori(
      ...
      props: {
        ...
        children: [
          ...
          },
          {
            type: 'div',
            props: {
              style: { display: 'flex', fontSize: 76, fontWeight: 700, color: text, fontFamily: 'Fraunces', lineHeight: 1.05 },
    ...
    },
    {
      ...
      fonts: [
        ...
        { name: 'Mulish', data: body, weight: 400, style: 'normal' },
      ],
    },
  )
